  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5">
      <div className="rounded-[1.5rem] border border-black/10 bg-[var(--dc-gray-100)]/65 p-4">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--dc-orange)]">Contact details</p>
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          <input
            value={defaultEmail}
            disabled
            className="h-12 w-full rounded-2xl border border-black/10 bg-white px-4 text-[var(--dc-gray-700)]"
          />
          <input
            value={phone}
          ...
          <input
            ...
            className="h-12 w-full rounded-2xl border border-black/15 bg-white px-4 outline-none focus:border-[var(--dc-orange)] md:col-span-2"
          />
        </div>
      ...
      <div className="rounded-[1.5rem] border border-black/10 bg-[var(--dc-gray-100)]/65 p-4">
        ...
        <p className="mt-2 text-xs text-[var(--dc-gray-700)]">
          This is the address we use for route planning and monthly pickup reminders.
        </p>
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <input
          ...
          placeholder="City"
          className="h-12 w-full rounded-2xl border border-black/15 px-4 outline-none focus:border-[var(--dc-orange)] md:col-span-1"
        />
        <input
          required
          maxLength={2}
